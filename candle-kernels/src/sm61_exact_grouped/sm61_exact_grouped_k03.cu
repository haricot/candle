...
extern "C" __global__ __launch_bounds__(BLOCK_X) void flow_v0322_ct1d_s32_g16_u1_b256(const float* __restrict__ x,const float* __restrict__ w,float* __restrict__ y){

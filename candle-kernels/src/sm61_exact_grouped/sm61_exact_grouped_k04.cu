...
extern "C" __global__ __launch_bounds__(BLOCK_X) void flow_v0322_ct2d_s32_g16_u4_b128(const float* __restrict__ x,const float* __restrict__ w,float* __restrict__ y){
